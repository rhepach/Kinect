...
setwd("/Volumes/ERZW/FEUK/HAUN LAB/STUDIEN/STELLA/Kinect/Kinect/R-processing V1.1/RImages")
# The .RData file should be in the same folder as the script. 
# Load image files.
load("./kinect_procs_Step1-2020-02-14.RData")
...
myData.chest.4plot = myData.chest.blcorrected
myData.hip.4plot = myData.hip.blcorrected
...
Test_1.chest = myData.chest.4plot[ myData.str.condensed $Condition =="Test 1-1"   ,]
